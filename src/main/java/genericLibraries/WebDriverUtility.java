...
public class WebDriverUtility {
     ...
     /**
      * This method is used to switch to frame onindex
      * @param index
      */
     ...
     /**
      * This method is used to switch to frame based or id or name attribute
      * @param index
      */
     ...
     /**
      * This method is used to switch to frame based or frame element reference
      * @param index
      */
     ...
     public void takesScreenshot(WebDriver driver,String className, JavaUtility jutil) {
